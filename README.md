## Привет!</br>
Меня зовут Дмитрий Поликарпов и в данный момент я аналитик данных на проекте прогнозирования спроса в федеральном ритейлере. Также я учусь в магистратуре МФТИ по специальности Инженер Data Science.</br></br>
